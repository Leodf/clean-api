...
describe('SignUp Controller', () => {
  test('Deve retornar status 400 se não passar um nome no body da requisição', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        email: 'any_email@mail.com',
  ...
  test('Deve retornar status 400 se não passar um email no body da requisição', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Deve retornar status 400 se não passar um password no body da requisição', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Deve retornar status 400 se não passar um passwordConfirmation no body da requisição', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Deve retornar status 400 se o email for inválido', async () => {
  ...
  test('Deve retornar status 500 se o EmailValidator retornar uma exceção', async () => {
    const { sut, emailValidatorStub } = makeSut()
